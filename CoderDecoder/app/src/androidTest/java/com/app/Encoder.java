...
public class Encoder {
    ...
    public Encoder(String input, int key){
        input.toLowerCase();
        this.input = input;
        makeCharList();
    ...
    public void getString(){
        System.out.print("Enter the string that you wish to encrypt(lowercase only): ");
    ...
    //Checks if the integer for the letters list is under 25 and if not then provides corresponding number
